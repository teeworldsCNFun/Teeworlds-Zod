...
MACRO_CONFIG_STR(SvGametype, sv_gametype, 32, "zod", CFGFLAG_SERVER, "Game type (dm, tdm, ctf)")
...
MACRO_CONFIG_INT(SvSpectatorSlots, sv_spectator_slots, 0, 0, 16, CFGFLAG_SERVER, "Number of slots to reserve for spectators")
...
MACRO_CONFIG_INT(SvVoteKickMin, sv_vote_kick_min, 0, 0, 16, CFGFLAG_SERVER, "Minimum number of players required to start a kick vote")
...
MACRO_CONFIG_INT(SvLongFly, sv_longfly, 0, 0, 1, CFGFLAG_SERVER, "Enablmpe Longfly Settings")
MACRO_CONFIG_INT(SvDieDelay, sv_die_delay, 0, 0, 60, CFGFLAG_SERVER, "Time delay for dying")
