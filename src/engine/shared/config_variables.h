...
MACRO_CONFIG_INT(SvMaxClients, sv_max_clients, 16, 1, 16, CFGFLAG_SERVER, "Maximum number of clients that are allowed on a server")
MACRO_CONFIG_INT(SvMaxClientsPerIP, sv_max_clients_per_ip, 4, 1, 16, CFGFLAG_SERVER, "Maximum number of clients with the same IP that can connect to the server")
